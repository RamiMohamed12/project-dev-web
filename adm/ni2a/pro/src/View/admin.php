...
$companyModel = new CompanyModel($conn); // Ajouter $conn comme paramètre
$internshipModel = new InternshipModel($conn); // Ajouter $conn comme paramètre
$applicationModel = new ApplicationModel($conn); // Ajouter $conn comme paramètre
