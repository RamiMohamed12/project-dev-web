...
// After getting logged-in user info
$profilePicSrc = '../View/images/default_avatar.png'; // Default image
try {
    ...
    if ($userDetails && !empty($userDetails['profile_picture']) && !empty($userDetails['profile_picture_mime'])) {
